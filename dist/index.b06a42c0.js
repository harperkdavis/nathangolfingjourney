 ...
 */ !function(t, e) {
    ...
    function r1(t, e, r) {
        return e && n1(t.prototype, e), r && n1(t, r), t;
    }
    function i1() {
    ...
    function s1(t2) {
        return s1 = Object.setPrototypeOf ? Object.getPrototypeOf : function(t) {
    ...
    function u1(t4, e3, n2) {
        return u1 = c1() ? Reflect.construct : function(t, e, n) {
            var r = [
                null
            ];
            r.push.apply(r, e);
    ...
    function d(t6, e4, n3) {
        return d = "undefined" != typeof Reflect && Reflect.get ? Reflect.get : function(t7, e5, n) {
            var r = function(t, e) {
                for(; !Object.prototype.hasOwnProperty.call(t, e) && null !== (t = s1(t)););
                return t;
            }(t7, e5);
            if (r) {
                var i = Object.getOwnPropertyDescriptor(r, e5);
    ...
    function v(t8, e6) {
        var n4 = "undefined" != typeof Symbol && t8[Symbol.iterator] || t8["@@iterator"];
        if (!n4) {
            if (Array.isArray(t8) || (n4 = function(t, e) {
                if (t) {
                    if ("string" == typeof t) return y(t, e);
                    var n = Object.prototype.toString.call(t).slice(8, -1);
                    return "Object" === n && t.constructor && (n = t.constructor.name), "Map" === n || "Set" === n ? Array.from(t) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? y(t, e) : void 0;
                }
            }(t8)) || e6 && t8 && "number" == typeof t8.length) {
                n4 && (t8 = n4);
                var r = 0, i = function() {};
                return {
                    s: i,
    ...
    for(var k = {
        ...
        return b && o instanceof Blob ? e ? n(o) : A(o, n) : w && (o instanceof ArrayBuffer || (r = o, "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer)) ? e ? n(o) : A(new Blob([
            o
        ]), n) : n(g[i] + (o || ""));
    }, A = function(t9, e) {
    ...
    function P(t) {
        for(var e8 = arguments.length, n7 = new Array(e8 > 1 ? e8 - 1 : 0), r = 1; r < e8; r++)n7[r - 1] = arguments[r];
    ...
    var D, F = function(t12) {
        o1(r, t12);
        var n = p(r);
        function r(t, i, o) {
            var s;
            return e1(this, r), (s = n.call(this, t)).description = i, s.context = o, s.type = "TransportError", s;
        }
        return r;
    }(h1(Error)), M = function(t13) {
        o1(i, t13);
        var n8 = p(i);
        function i(t) {
            var r;
            return e1(this, i), (r = n8.call(this)).writable = !1, I(f1(r), t), r.opts = t, r.query = t.query, r.readyState = "", r.socket = t.socket, r;
        }
        return r1(i, [
            {
                key: "onError",
                value: function(t, e, n) {
                    return d(s1(i.prototype), "emitReserved", this).call(this, "error", new F(t, e, n)), this;
                }
            },
            {
                key: "open",
            ...
            },
            {
                key: "onOpen",
                value: function() {
                    this.readyState = "open", this.writable = !0, d(s1(i.prototype), "emitReserved", this).call(this, "open");
                }
            },
            {
                key: "onData",
            ...
            },
            {
                key: "onPacket",
                value: function(t) {
                    d(s1(i.prototype), "emitReserved", this).call(this, "packet", t);
                }
            },
            {
                key: "onClose",
                value: function(t) {
                    this.readyState = "closed", d(s1(i.prototype), "emitReserved", this).call(this, "close", t);
                }
            }
        ]), i;
    ...
    function Y(t) {
        var e = "";
        do e = U[t % 64] + e, t = Math.floor(t / 64);
        while (t > 0);
        return e;
    }
    function z() {
    ...
    var Z = null != new G({
        ...
        return r1(s, [
            ...
            },
            {
                ...
                value: function(t18) {
                    ...
                    (function(t, e) {
                        ...
                        return r;
                    })(t18, this.socket.binaryType).forEach(function(t) {
                        if ("opening" === e9.readyState && "open" === t.type && e9.onOpen(), "close" === t.type) return e9.onClose({
            ...
            },
            {
                ...
                value: function(t19) {
                    var e10 = this;
                    this.writable = !1, function(t20, e) {
                        var n = t20.length, r = new Array(n), i = 0;
                        t20.forEach(function(t21, o) {
                            _(t21, !1, function(t) {
                                r[o] = t, ++i === n && e(r.join(N));
                            });
                        });
                    }(t19, function(t) {
                        e10.doWrite(t, function() {
                            e10.writable = !0, e10.emitReserved("drain");
                        });
                    });
                }
            },
            ...
            {
                key: "doWrite",
                value: function(t22, e11) {
                    var n = this, r = this.request({
                        method: "POST",
                        data: t22
                    });
                    r.on("success", e11), r.on("error", function(t, e) {
            ...
            },
            {
                key: "doPoll",
                value: function() {
                    var t = this, e12 = this.request();
                    e12.on("data", this.onData.bind(this)), e12.on("error", function(e, n) {
        ...
        function i(t, r) {
            var o;
            return e1(this, i), I(f1(o = n10.call(this)), r), o.opts = r, o.method = r.method || "GET", o.uri = t, o.async = !1 !== r.async, o.data = void 0 !== r.data ? r.data : null, o.create(), o;
        }
        return r1(i, [
            {
                key: "create",
                value: function() {
                    var t = this, e = P(this.opts, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
    ...
    var rt = "function" == typeof Promise && "function" == typeof Promise.resolve ? function(t) {
        ...
        return e(t, 0);
    }, it = L.WebSocket || L.MozWebSocket, ot = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase(), st = function(t27) {
        o1(i2, t27);
        var n11 = p(i2);
        function i2(t) {
            var r;
        ...
        return r1(i2, [
            ...
            },
            {
                ...
                value: function() {
                    if (this.check()) {
                        var t = this.uri(), e = this.opts.protocols, n = ot ? {} : P(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
                        this.opts.extraHeaders && (n.headers = this.opts.extraHeaders);
                        try {
                            this.ws = ot ? new it(t, e, n) : e ? new it(t, e) : new it(t);
                        } catch (t28) {
                            return this.emitReserved("error", t28);
                        }
            ...
            },
            {
                ...
                value: function(t29) {
                    var e = this;
                    this.writable = !1;
                    for(var n12 = function(n) {
                        var r = t29[n], i = n === t29.length - 1;
            ...
            },
            {
                key: "check",
                value: function() {
                    return !(!it || "__initialize" in it && this.name === i2.prototype.name);
                }
            }
        ]), i2;
    }(M), at = {
        websocket: st,
        polling: tt
    }, ct = /^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/, ut = [
        "source",
        "protocol",
        "authority",
        "userInfo",
    ...
    function ht(t) {
        var e14 = t, n13 = t.indexOf("["), r3 = t.indexOf("]");
        -1 != n13 && -1 != r3 && (t = t.substring(0, n13) + t.substring(n13, r3).replace(/:/g, ";") + t.substring(r3, t.length));
        for(var i, o, s = ct.exec(t || ""), a = {}, c = 14; c--;)a[ut[c]] = s[c] || "";
        return -1 != n13 && -1 != r3 && (a.source = e14, a.host = a.host.substring(1, a.host.length - 1).replace(/;/g, ":"), a.authority = a.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), a.ipv6uri = !0), a.pathNames = function(t, e) {
    ...
    var ft = function(n14) {
        ...
        function a(n) {
            ...
            return e1(this, a), r = s2.call(this), n && "object" === t1(n) && (o = n, n = null), n ? (n = ht(n), o.hostname = n.host, o.secure = "https" === n.protocol || "wss" === n.protocol, o.port = n.port, n.query && (o.query = n.query)) : o.host && (o.hostname = ht(o.host).host), I(f1(r), o), r.secure = null != o.secure ? o.secure : "undefined" != typeof location && "https:" === location.protocol, o.hostname && !o.port && (o.port = r.secure ? "443" : "80"), r.hostname = o.hostname || ("undefined" != typeof location ? location.hostname : "localhost"), r.port = o.port || ("undefined" != typeof location && location.port ? location.port : r.secure ? "443" : "80"), r.transports = o.transports || [
                "polling",
                "websocket"
            ], r.readyState = "", r.writeBuffer = [], r.prevBufferLen = 0, r.opts = i1({
                path: "/engine.io",
                agent: !1,
                withCredentials: !1,
                upgrade: !0,
        ...
        return r1(a, [
            ...
            },
            {
                ...
                value: function(t32) {
                    var e = this;
                    this.transport && this.transport.removeAllListeners(), this.transport = t32, t32.on("drain", this.onDrain.bind(this)).on("packet", this.onPacket.bind(this)).on("error", this.onError.bind(this)).on("close", function(t) {
            ...
            },
            {
                key: "probe",
                value: function(t33) {
                    var e = this, n = this.createTransport(t33), r4 = !1;
            ...
            },
            {
                ...
                value: function() {
                    ...
                    for(var t34, e15 = 1, n15 = 0; n15 < this.writeBuffer.length; n15++){
                        var r5 = this.writeBuffer[n15].data;
                        if (r5 && (e15 += "string" == typeof (t34 = r5) ? function(t) {
                            for(var e = 0, n = 0, r = 0, i = t.length; r < i; r++)(e = t.charCodeAt(r)) < 128 ? n += 1 : e < 2048 ? n += 2 : e < 55296 || e >= 57344 ? n += 3 : (r++, n += 4);
                            return n;
                        }(t34) : Math.ceil(1.33 * (t34.byteLength || t34.size))), n15 > 0 && e15 > this.maxPayload) return this.writeBuffer.slice(0, n15);
                        e15 += 2;
                    }
            ...
            },
            {
                ...
                value: function() {
                    var t = this, e = function() {
                        ...
                        t.once("upgrade", n16), t.once("upgradeError", n16);
                    };
    ...
    ft.protocol = 4;
    var lt = "function" == typeof ArrayBuffer, pt = Object.prototype.toString, dt = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === pt.call(Blob), yt = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === pt.call(File);
    function vt(t35) {
        return lt && (t35 instanceof ArrayBuffer || function(t) {
            return "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t.buffer instanceof ArrayBuffer;
        }(t35)) || dt && t35 instanceof Blob || yt && t35 instanceof File;
    }
    function gt(e, n) {
    ...
    function wt(e, n) {
        ...
        else if ("object" === t1(e)) for(var i in e)Object.prototype.hasOwnProperty.call(e, i) && (e[i] = wt(e[i], n));
        return e;
    }
    var _t;
    !function(t) {
    ...
    var At = function() {
        ...
        return r1(a, [
            {
                ...
                value: function(t) {
                    var e;
                    if ("string" == typeof t) (e = this.decodeString(t)).type === _t.BINARY_EVENT || e.type === _t.BINARY_ACK ? (this.reconstructor = new Ot(e), 0 === e.attachments && d(s1(a.prototype), "emitReserved", this).call(this, "decoded", e)) : d(s1(a.prototype), "emitReserved", this).call(this, "decoded", e);
                    else {
                        if (!vt(t) && !t.base64) throw new Error("Unknown type: " + t);
                        if (!this.reconstructor) throw new Error("got binary data when not reconstructing a packet");
                        (e = this.reconstructor.takeBinaryData(t)) && (this.reconstructor = null, d(s1(a.prototype), "emitReserved", this).call(this, "decoded", e));
                    }
                }
            },
            {
        ...
        function t38(n) {
            e1(this, t38), this.packet = n, this.buffers = [], this.reconPack = n;
        }
        return r1(t38, [
            {
                key: "takeBinaryData",
    ...
    var Ct = Object.freeze({
        ...
        function i5(t, r, o) {
            var s;
            return e1(this, i5), (s = n18.call(this)).connected = !1, s.receiveBuffer = [], s.sendBuffer = [], s.ids = 0, s.acks = {}, s.flags = {}, s.io = t, s.nsp = r, o && o.auth && (s.auth = o.auth), s.io._autoConnect && s.open(), s;
        }
        return r1(i5, [
            {
                key: "disconnected",
            ...
            },
            {
                ...
                value: function(t40, e) {
                    var n = this, r7 = this.flags.timeout;
                    if (void 0 !== r7) {
                        var i = this.io.setTimeoutFn(function() {
                            delete n.acks[t40];
                            for(var r = 0; r < n.sendBuffer.length; r++)n.sendBuffer[r].id === t40 && n.sendBuffer.splice(r, 1);
                            e.call(n, new Error("operation has timed out"));
                        }, r7);
                        this.acks[t40] = function() {
            ...
            },
            {
                ...
                value: function(t) {
                    ...
                    d(s1(i5.prototype), "emit", this).apply(this, t);
                }
            },
            {
                key: "ack",
        ...
        return r1(s3, [
            ...
            },
            {
                ...
                value: function(t) {
                    ...
                    var n20 = this.engine, r = this;
                    this._readyState = "opening", this.skipReconnect = !1;
                    var i = Tt(n20, "open", function() {
                        r.onopen(), t && t();
                    }), o = Tt(n20, "error", function(n) {
                    ...
                    if (!1 !== this._timeout) {
                        ...
                        var a = this.setTimeoutFn(function() {
                            i(), n20.close(), n20.emit("error", new Error("timeout"));
                        }, s);
    ...
    function Lt(e16, n23) {
        "object" === t1(e16) && (n23 = e16, e16 = void 0);
        var r8, i7 = function(t) {
        ...
        }(e16, (n23 = n23 || {}).path || "/socket.io"), o = i7.source, s = i7.id, a = i7.path, c = xt[s] && a in xt[s].nsps;
        return n23.forceNew || n23["force new connection"] || !1 === n23.multiplex || c ? r8 = new Nt(o, n23) : (xt[s] || (xt[s] = new Nt(o, n23)), r8 = xt[s]), i7.query && !n23.query && (n23.query = i7.queryKey), r8.socket(i7.path, n23);
    }
    return i1(Lt, {
        Manager: Nt,
        Socket: Bt,
